...
`$0 \cdot$` `$w_{1,1}$` `$ +\ 1 \cdot$` `$ w_{1,2}$`<!-- .element: data-id="w12" --> `$ +\ 1 \cdot$` `$ w_{1,3}$`<!-- .element: data-id="w13" --> `$ +\ 0 \cdot$` `$ w_{1,4}$` `$ +\ b_1 = 1$`<!-- .element: data-id="b1-1" -->

`$0 \cdot$` `$ w_{2,1}$` `$ +\ 1 \cdot$` `$ w_{2,2}$`<!-- .element: data-id="w22" --> `$ +\ 1 \cdot$` `$ w_{2,3}$`<!-- .element: data-id="w23" --> `$ +\ 0 \cdot$` `$ w_{2,4}$` `$ +\ b_2 = 0$`<!-- .element: data-id="b2-1" -->

and

`$1 \cdot$` `$ w_{1,1}$`<!-- .element: data-id="w11" --> `$ +\ 0 \cdot$` `$ w_{1,2}$` `$ +\ 0 \cdot w_{1,3}$` `$ +\ 1 \cdot$` `$ w_{1,4}$`<!-- .element: data-id="w14" --> `$ +\ b_1 = 0$`<!-- .element: data-id="b1-2" -->
 
`$1 \cdot$` `$ w_{2,1}$`<!-- .element: data-id="w21" --> `$ +\ 0 \cdot$` `$ w_{2,2}$` `$ +\ 0 \cdot w_{2,3}$` `$ +\ 1 \cdot$` `$ w_{2,4}$`<!-- .element: data-id="w24" --> `$ +\ b_2 = 1$`<!-- .element: data-id="b1-2" -->
...
`$w_{1,2}$`<!-- .element: data-id="w12" --> `$ + $` `$w_{1,3}$`<!-- .element: data-id="w13" --> `$ +\ b_1 = 1$`<!-- .element: data-id="b1-1" -->

`$w_{2,2}$`<!-- .element: data-id="w22" --> `$ + $` `$w_{2,3}$`<!-- .element: data-id="w23" --> `$ +\ b_2 = 0$`<!-- .element: data-id="b2-1" -->

`$w_{1,1}$`<!-- .element: data-id="w11" --> `$ + $` `$w_{1,4}$`<!-- .element: data-id="w14" --> `$ +\ b_1 = 0$`<!-- .element: data-id="b1-2" -->

`$w_{2,1}$`<!-- .element: data-id="w21" --> `$ + $` `$w_{2,4}$`<!-- .element: data-id="w24" --> `$ +\ b_2 = 1$`<!-- .element: data-id="b2-2" -->
