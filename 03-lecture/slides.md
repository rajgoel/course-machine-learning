...
> `$$\genfrac{}{}{1pt}{1}{\partial \sigma^l_i(z^l_i)}{\partial z^l_i } = \begin{cases}1& \textrm{ if } z^l_i > 0 \\ 0 &\textrm{ if } z^l_i = 0 \textrm{ (by convention, formally undefined!)} \\ 0 &\textrm{ if } z^l_i < 0 \end{cases}$$`
